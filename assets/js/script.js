...
const translations = {
	en: {
		...
		'header.repo.en': 'GitHub repo (EN)',
		'header.repo.en.title': 'Open the English GitHub repository',
		'header.repo.fr': 'GitHub repo (FR)',
		'header.repo.fr.title': 'Open the French GitHub repository',

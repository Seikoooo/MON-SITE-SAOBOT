...
const translations = {
	...
	fr: {
		...
		'hero.lead': 'Conçu pour les environnements compétitifs des FPS tactiques professionnels, SAOBOT combine aim assist, auto aim, contrôle du recul et spoofing PID/HID/Arduino pour des sessions ultra stables et discrètes.',
		...
		'partners.copy': 'Chaque module d\'aimbot, triggerbot et spoofing matériel garde une signature humaine tout en dépassant la méta classée des FPS tactiques.',
		...
		'split.left.heading': 'Conçu pour la scène FPS tactique',
		...
		'terms.section2.heading': 'Anti-cheat et juridiction',
		'terms.section2.copy': 'Chaque utilisateur doit respecter les lois locales ainsi que les politiques des jeux ou plateformes visés. SAOBOT n\'est affilié à aucun éditeur et vous assumez seul les conséquences de toute automatisation non autorisée.',
		'terms.section3.eyebrow': '3. Paiements et remboursements',
		'terms.section3.heading': 'Politique de facturation',
		'terms.section3.copy': 'Les paiements sont traités via Stripe. Le renouvellement est mensuel jusqu\'à annulation. L\'accès numérique étant immédiat, les ventes sont définitives ; les remboursements ne sont étudiés qu\'en l\'absence d\'activation.',
		'terms.section4.eyebrow': '4. Exigences matérielles',
		'terms.section4.heading': 'Respect de l\'Arduino',
		'terms.section4.copy': 'Un Arduino Leonardo (ou carte approuvée par l\'équipe SAOBOT) est obligatoire pour le spoof HID et l\'injection sécurisée. Toute tentative de contournement entraîne la désactivation définitive de la licence.',
		...
		'license.section3.copy': 'Les licences actives incluent les mises à jour mineures et la maintenance des contournements anti-cheat. L\'accès aux fonctions bêta peut être suspendu si la stabilité ou la conformité est menacée.',
		'license.section4.eyebrow': '4. Résiliation',
		'license.section4.heading': 'Motifs de suspension',
		'license.section4.copy': 'Les licences peuvent être résiliées en cas de paiement frauduleux, litige bancaire, harcèlement, fuite de builds privés ou non-respect de l\'exigence Arduino. Les comptes résiliés perdent l\'accès immédiatement.',
